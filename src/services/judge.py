...
class JudgeService:
    ...
    def judge_once(self, prompt_text: str, out_a: str, out_b: str, judge_model_id: str, timeout: int = 120) -> Dict:
        ...
        try:
            ...
            max_tokens = 200 if "deepseek" in judge_model_id.lower() else 32
    ...
    def debug_judge_response(self, prompt_text: str, out_a: str, out_b: str, judge_model_id: str, timeout: int = 120) -> Dict:
        ...
        res = self.client.call(
            judge_model_id, 
            judge_prompt, 
            max_tokens=50,  # More tokens for debugging
            temperature=0.0, 
            top_p=1.0, 
            timeout=timeout
        )
        ...
        if res.get("ok") and "text" in res:
            decision = self._extract_decision(res["text"])
